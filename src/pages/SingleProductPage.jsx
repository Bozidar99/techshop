    ...
    <div className='px-[20px] mb-5'>
      {isLoading ? <div className='container mx-auto flex flex-col lg:flex-row gap-[40px] lg:gap-[20px]'>
        ...
        <div className='w-full lg:w-[50%]'>
          <img src={singleProduct.images[currentImage]} alt={singleProduct.title} className='w-full h-[600px] object-cover ' />
        ...
        <div className='w-full lg:w-[50%] flex flex-col gap-[15px] mt-[70px] '>
          ...
          <div className='flex gap-[15px]'>
            <button className='bg-mainYellow text-whiteColor px-[40px] py-[10px] rounded-[20px] hover:bg-mainBlue'>Add to Cart</button>
